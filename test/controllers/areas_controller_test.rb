...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { gugun_id: @area.gugun_id, local_id: @area.local_id, nation_id: @area.nation_id, sido_id: @area.sido_id } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { gugun_id: @area.gugun_id, local_id: @area.local_id, nation_id: @area.nation_id, sido_id: @area.sido_id } }
